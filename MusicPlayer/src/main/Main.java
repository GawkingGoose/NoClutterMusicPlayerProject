...
import displays.UIMainMusicView;
import objects.Tune;
import objects.TuneGenre;
...
public class Main {
    ...
    public static void main(String[] argv) {
    	...
    	UIMainMusicView view = new UIMainMusicView();
    	view.createComposite(new Display(), manager);
    ...
    public static void demoSimplePlay(){
    	TuneManager manager = new TuneManager();
